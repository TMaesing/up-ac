...
def get_OAT():
    ...
    if platform in ("linux", "linux2"):
        ...
        url = 'https://docs.optano.com/algorithm.tuner/current/OPTANO.Algorithm.Tuner.Application.2.1.0_osx-x64.zip'
    elif platform == "win32":
        url = 'https://docs.optano.com/algorithm.tuner/current/OPTANO.Algorithm.Tuner.Application.2.1.0_win-x64.zip'
    ...
    if os.path.isfile(f'{path}/OAT/OAT.zip') and \
            not os.path.isfile(f'{path}/OAT/Optano.Algorithm.Tuner.Application'):
