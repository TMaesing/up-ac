...
operation_modes = ['OneshotPlanner', 'AnytimePlanner']
...
if __name__ == '__main__':
    ...
    for metric in metrics:
        for om in operation_modes:
            ...
            AC_fb_func = AC.get_feedback_function('irace', gaci, engine[0], metric, om)
            ...
            perf = AC.evaluate('irace', metric, engine[0], om, AC.incumbent, gaci)
    ...
    for metric in metrics:
        for om in operation_modes:
            ...
            AC.set_training_instance_set(instances)
            AC.set_test_instance_set(instances)
            AC_fb_func = AC.get_feedback_function('SMAC', gaci, engine[0], metric, om)
            ...
            # check configurations performance
            perf = AC.evaluate('SMAC', metric, engine[0], om, AC.incumbent, gaci)
            # save best configuration found
